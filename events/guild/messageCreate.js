                ...
                try {
                    ...
                    if (command.premium && premiumServer && !premiumServer.isPremium) {
                        return message.reply({
                            embeds: [new MessageEmbed()
                                ...
                                Join **[Rexon Support](${process.env.SUPPORT})** And **Open a Ticket!**`)
                                .setColor(ee.wrongcolor)
                            ]
                        })
                    }
                    ...
                    commandLogsChannel.send({
                        embeds: [new MessageEmbed()
                            ...
                            .setTitle(`<:Rexon:1122482773609947256> Prefix Command`)
                            .addField("**<a:Icon_Dot:1065167651493646356> Author**", `\`\`\`${message.author.tag}\`\`\``)
