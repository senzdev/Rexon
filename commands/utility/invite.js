...
module.exports = {
  ...
  async execute(client, message, args, ee) {
    ...
    let embed = new MessageEmbed()
      ...
      .setDescription(`[Click here for an Invite link without Slash Commands](https://discord.com/api/oauth2/authorize?client_id=950313063473643520&permissions=536870911999&scope=bot)`)
      .setColor(ee.color)
