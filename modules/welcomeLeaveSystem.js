...
module.exports = async (client) => {
    ...
    client.on("guildMemberAdd", async (member) => {
        ...
        try {
            ...
            var backgroundArray = [
              `https://cdn.discordapp.com/attachments/1047826356173537300/1065869150947385384/senzz..gif`,
          `https://cdn.discordapp.com/attachments/907875631000334346/910146026382430249/v2cmfx8rbdv11.jpg`,
            ...
            Schema.findOne({
              ...
              var textString4 = `YOU ARE THE ${member.guild.memberCount} MEMBER OF OUR SERVER`;
              ctx.textAlign = 'center';
